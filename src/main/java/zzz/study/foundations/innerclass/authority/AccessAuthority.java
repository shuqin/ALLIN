...
public class AccessAuthority {
	...
	private class PrivateInnerclass {
		private int i;
		PrivateInnerclass(int i) {this.i = i;}
		
		PrivateInnerclass() {this.i = 0;}
	...
	public class PublicInnerclass {
		private int i;
		public PublicInnerclass(int i) {this.i = i;}
		
		public PublicInnerclass() {this.i = 0;}

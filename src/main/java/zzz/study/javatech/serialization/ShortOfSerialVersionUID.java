...
public class ShortOfSerialVersionUID {
...
//	    xmlSerialization(xmls);
	...
	public static void geneSerialization(GeneralSerialization gs)
	{
		...
		try {
			gs.serializeToDisk(point, "./src/javatech/serialization/point.bin");
	...
	public static void geneDeserialization(GeneralSerialization gs)
	{
		...
		Point point;
		try {
			point = (Point) gs.deSerizalize("./src/javatech/serialization/point.bin");
	...
	public static void xmlSerialization(XMLSerialization xmls)
	{
		...
		try {
			xmls.serializeToDisk(point, "./src/javatech/serialization/point.xml");
		} catch (FileNotFoundException e) {
	...
	public static void xmlDeserialization(XMLSerialization xmls)
	{
		...
		Point point = null;
		try {
			point = (Point) xmls.deSerizalize("./src/javatech/serialization/point.xml");
		} catch (FileNotFoundException e) {
			System.out.println(e.getMessage());
		}
		System.out.println(point);		

 ...
 */
public class HashMemoryTable extends AbstractTable implements FilterableTable {

    private BizTable bizTable;
    private RelDataType relDataType;

    public HashMemoryTable(BizTable bizTable) {
    ...
    public Enumerable<Object[]> scan(DataContext dataContext, List<RexNode> filters) {
        ...
        for (List<String> line : tableDataFiltered) {
            if (line != null || line.size() > 0) {
                hashes.add(new Object[]{line.get(0)});
            }
        }
        ...
        return new AbstractEnumerable<Object[]>() {
            ...
            public Enumerator<Object[]> enumerator() {
                return Linq4j.enumerator(hashes);
            }
        };
    }

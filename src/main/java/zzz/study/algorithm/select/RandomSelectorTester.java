			...
			try {
				...
				while ((input = bReader.readLine()) != null && input.length() != 0) {
					if (input.matches("\\s*[0-9]\\s*")) {
						...
						switch (choice) {
						   case 0 : break;
						   case 1 : testSelectMOrdered(); break;
						   case 2 : testSelectMOrdered2(); break;
						   case 3 : testSelectMOrdered3(); break;
						   case 4 : testSelectMDisordered(); break;
						   case 5 : testSelectMDisordered2(); break;
						   case 6 : testSelectMDisordered3(); break;
						   case 7 : testBigRandInt(); break;
						   case 8 : testRandRange(); break;
						   case 9:  menu();break;
						   default : break;
						}
					} else {
